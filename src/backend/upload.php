...
if($_FILES["file"]["size"] > 0) {
    ...
    if ($header === false || array_map('strtolower', $header) !== $expectedHeaders) {
        echo "<div id='notif-del' class='grid grid-cols-2  items-center p-4 rounded-md bg-[#FFF2D0] text-[#937E43] opacity-100 transition-opacity duration-100 mx-4 std:mx-0'>
