           ...
           <div class="grid grid-cols-2 items-center shadow-md px-8 py-2 std:py-2 bg-white">
                <div class="text-xl std:text-3xl ">
                    ...
                    <div class="flex items-center">
                        <p class="text-[16px] std:text-[20px] italic">Generate Documents</p>
            ...
            <div class="grid content-center h-[90%] bg-cover bg-center bg-fixed z-10" >
                <div class=" place-items-center">
                    <p class="font-bold text-white text-3xl std:text-5xl mb-4">Select a Document</p>
                    <p class="border-t-4 border-c w-[15%] std:w-1/5 rounded-sm mb-20"></p>
                </div>
                <div class="grid grid-cols-3  place-self-center gap-x-28 z-20 text-base std:text-lg">
                    <!-- Barangay Clearance -->
                    <div>
                        <div class="border-2 border-sg rounded-t-xl bg-c h-32 std:h-48 w-56 std:w-64 flex justify-center items-center">
                            <div>
                        ...
                        <a href="documents/brgyclearance.php">
                            <div class="border-x-2 border-b-2 border-sg rounded-b-xl h-12  w-56 std:w-64 flex justify-center items-center bg-sg hover:text-white active:bg-sg transition duration-700 cursor-pointer ">
                                <button>
                                    Generate
                                </button>
                            </div>
