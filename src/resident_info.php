...
<body class="bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]">
    ...
    <div class="flex justify-end items-center space-x-4 mr-32">
        ...
        <button class="bg-pg text-black py-1 px-3 hover:bg-pg focus:outline-none rounded-sm">Add New</button>
    </div>
    <!-- Smaller Table with minimal padding and font size -->
    <div class="overflow-x-auto pr-32 pl-32 mt-4">
        <table class="min-w-full bg-white border border-gray-300">
            <thead>
                <tr class="bg-c text-gray-600 uppercase text-xs leading-none border-2">
                    <th class="border-2">ID</th>
                    <th class="border-2">Last Name</th>
                    <th class="border-2">First Name</th>
                    <th class="border-2">Middle Name</th>
                    <th class="border-2">Suffix</th>
                    <th class="border-2">Age</th>
                    <th class="border-2">Address</th>
                    <th class="border-2">Sex</th>
                    <th class="border-2">Date of Birth</th>
                    <th class="border-2">Birth Place</th>
                    <th class="border-2">Civil Status</th>
                    <th class="border-2">Citizenship</th>
                    <th class="border-2">Occupation</th>
                    <th class="border-2">Action</th>
                </tr>
            </thead>
            <tbody>
                <tr class="text-gray-600 text-xs font-light border-2">
